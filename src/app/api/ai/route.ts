...
// const MODEL = process.env.GEMINI_MODEL || "gemini-2.0-pro"; // set to your 2.5 Pro model name
...
//   // Build schema and instruction per task
...
//                   ],
//                 },
//                 // Minimal fields to keep strictness but short
//                 tasks: {
...
//     task === "nlToDsl"
//       ? "Translate the user query into a tiny, auditable DSL using only: includes(field,value), numeric comparisons (>, <, >=, <=, ==) on numeric fields, and AND/OR. Return JSON { dsl: string } and nothing else."
//       : "Produce a strict JSON object { rule: <Rule> } matching the provided union types. No prose, no comments, no extra keys beyond rule.";
