...
//         <div className="font-semibold">Prioritization & Weights</div>
//         <div className="flex gap-2">
//           <button
//             className="text-xs border rounded px-2 py-1"
//             onClick={() => onPreset("MaxFulfillment")}
//           >
//             Max Fulfillment
//           </button>
//           <button
//             className="text-xs border rounded px-2 py-1"
//             onClick={() => onPreset("FairDistribution")}
//           >
//             Fair Distribution
//           </button>
//           <button
//             className="text-xs border rounded px-2 py-1"
//             onClick={() => onPreset("MinWorkload")}
//           >
//             Min Workload
//           </button>
//         </div>
...
//             <div className="w-48 text-sm">{label(k)}</div>
//             <input
//               type="range"
//               min={0}
//               max={1}
